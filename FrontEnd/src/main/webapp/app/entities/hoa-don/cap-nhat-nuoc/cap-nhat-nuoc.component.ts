...
@Component({
  selector: 'jhi-cap-nhat-nuoc',
  templateUrl: './cap-nhat-nuoc.component.html',
  styleUrls: ['./cap-nhat-nuoc.component.scss']
})
export class CapNhatNuocComponent implements OnInit {
